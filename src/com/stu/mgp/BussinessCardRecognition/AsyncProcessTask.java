...
public class AsyncProcessTask extends AsyncTask<String, String, Boolean> {
	...
	public AsyncProcessTask(ResultsActivity activity, String language) {
...
//			!!! Please provide application id and password and remove this line. !!!
			...
			restClient.applicationId = "busscard recognization";
			// You should get e-mail from ABBYY Cloud OCR SDK service with the application password
			restClient.password = "PLkDtalX5G8Vl+qc2cXkJiQ5";
			...
			String language = mLanguage; // Comma-separated list: Japanese,English or German,French,Spanish etc.
